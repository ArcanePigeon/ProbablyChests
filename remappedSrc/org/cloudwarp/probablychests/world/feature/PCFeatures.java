...
public class PCFeatures {
	...
	public static final RegistryEntry<PlacedFeature> LUSH_CHEST_PLACED = PlacedFeatures.register("lush_chest_placed",
			...
			PCGroundPlacementModifier.of(Direction.DOWN, BlockPredicate.hasSturdyFace(Direction.UP), VALID_FLOOR, BlockPredicate.IS_AIR_OR_WATER, 8));
	...
	public static final RegistryEntry<PlacedFeature> NORMAL_POT_PLACED = PlacedFeatures.register("normal_pot_placed",
			...
			PCGroundPlacementModifier.of(Direction.DOWN, BlockPredicate.hasSturdyFace(Direction.UP), VALID_FLOOR, BlockPredicate.IS_AIR, 8));
