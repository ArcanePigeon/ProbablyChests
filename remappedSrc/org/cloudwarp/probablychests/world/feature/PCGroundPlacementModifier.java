...
public class PCGroundPlacementModifier extends PlacementModifier {
	...
	private PCGroundPlacementModifier (Direction direction, BlockPredicate directionPredicate, BlockPredicate directionBlockPredicate, BlockPredicate targetPredicate, int maxSteps) {
	...
	public static PCGroundPlacementModifier of (Direction direction, BlockPredicate directionPredicate, BlockPredicate directionBlockPredicate, BlockPredicate targetPredicate, int maxSteps) {
		return new PCGroundPlacementModifier(direction, directionPredicate, directionBlockPredicate, targetPredicate, maxSteps);
	}
